...
export interface CreateAdvertiserMetadataDto {
  name: string;
  description?: string;
  languageId: string;
}

export interface CreateAdvertiserCommissionRowDto {
  name: string;
  typeId: string;
  commission: number;
}

export interface CreateAdvertiserCommissionDto {
  providerReferenceId: string;
  dayToPayout: number;
  dayToValidate: number;
  url: string;
  commissionShareTypeId: "Percentage" | "Fixed";
  statusId: "Inactive" | "Active";
  commissionRows: CreateAdvertiserCommissionRowDto[];
}
...
export interface CreateAdvertiserDto {
  ...
  metadatas: CreateAdvertiserMetadataDto[];
  commission: CreateAdvertiserCommissionDto;
}

export interface UpdateAdvertiserCommissionDto {
  statusId: "Inactive" | "Active";
}
...
export interface UpdateAdvertiserDto {
  ...
  commission: UpdateAdvertiserCommissionDto;
}
...
export interface UpdateEmailStatusDto {
  email?: string;
  messageId: string;
  status: "ACCEPTED" | "PENDING" | "FAILED" | "DELIVERED" | "BOUNCED" | "SOFT_BOUNCED" | "COMPLAINT" | "REJECTED";
}

export interface SiteDto {
  /**
   * The supported languages of the site
   * @example ["EN_US","FR_FR"]
   */
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  s2S = {
     ...
     * @tags AffiliateS2S
     * @name GetAdvertiser
     * @request GET:/s2s/affiliate/advertisers
     * @secure
     */
    getAdvertiser: (
      query: {
      ...
      >({
        path: `/s2s/affiliate/advertisers`,
        method: "GET",
        query: query,
        secure: true,
        format: "json",
     ...
     * @request POST:/s2s/affiliate/advertisers
     * @secure
     */
    createAdvertiser: (data: CreateAdvertiserDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: AdvertiserDto;
        },
     ...
     *
     * @tags AffiliateS2S
     * @name UpdateAdvertiser
     * @request PATCH:/s2s/affiliate/advertisers/{id}
     * @secure
     */
    updateAdvertiser: (id: string, data: UpdateAdvertiserDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: AdvertiserDto;
        },
      ...
      >({
        path: `/s2s/affiliate/advertisers/${id}`,
        method: "PATCH",
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     * @secure
     */
    createAdvertiserCampaign: (data: CreateAdvertiserCampaignDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: AdvertiserCampaignDto;
        },
     ...
     * @secure
     */
    processUserCashback: (data: ProcessUserCashbackDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
     ...
     * @secure
     */
    updateEmailStatus: (data: UpdateEmailStatusDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: SendEmailResponseDto;
        },
     ...
     * @secure
     */
    sendUserSignUpWelcomeEmail: (data: CustomSendEmailDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: SendEmailResponseDto;
        },
     ...
     * @secure
     */
    sendForgotPasswordEmail: (data: CustomSendEmailDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: SendEmailResponseDto;
        },
  ...
  posts = {
     ...
     * @tags Posts
     * @name GetPostBySlug
     * @request GET:/posts/slug/{slug}
     */
    getPostBySlug: (slug: string, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: PostDto;
        },
     ...
     * @tags Posts
     * @name PublishPost
     * @request POST:/posts/{id}/publish
     */
    publishPost: (id: string, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: PostDto;
        },
  ...
  affiliate = {
     ...
     * @secure
     */
    createProvider: (data: CreateAffiliateProviderDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
     ...
     * @secure
     */
    updateProvider: (id: string, data: UpdateAffiliateProviderDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: AffiliateProviderDto;
        },
  ...
  wallet = {
     ...
     * @secure
     */
    getWalletByCurrencyCode: (currencyCode: string, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: WalletDto;
        },
     ...
     * @secure
     */
    createUserWithdrawal: (userWalletId: string, data: CreateUserWithdrawalDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
  ...
  paymentMethods = {
     ...
     * @secure
     */
    createUserPaymentMethod: (data: CreateUserPaymentMethodDto, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
          data: UserPaymentMethodDto;
        },
        {
          error: {
            message: "invalidPaymentChannel" | "invalidPaymentDirection" | "exceedNumOfUserPaymentMethod";
          };
        }
      >({
     ...
     * @secure
     */
    deletePaymentMethod: (paymentMethodId: string, params: RequestParams = {}) =>
      this.request<
        OkResponseDto & {
